export const getAudienceName = state => state.ca.audienceName;
export const getSelectedAdAccount = state => state.ca.selectedAdAccount;
export const getSelectedAudienceDate = state => state.ca.selectedAudienceDate;
export const getSelectedBM = state => state.ca.selectedBM;
